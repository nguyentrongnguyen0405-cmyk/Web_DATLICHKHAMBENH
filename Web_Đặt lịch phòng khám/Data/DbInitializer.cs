...
namespace Web_Đặt_lịch_phòng_khám.Data
{
    public static class DbInitializer
    {
        public static async Task InitializeAsync(IServiceProvider serviceProvider)
        {
            ...
            // Thêm chuyên khoa nếu chưa có
            if (!context.Specialties.Any())
            {
                context.Specialties.AddRange(
                    new Specialty { Name = "Khám tổng quát", Description = "Kiểm tra sức khỏe toàn diện", Price = "500.000đ", ShortDescription = "Gói khám tổng quát đầy đủ" },
                    new Specialty { Name = "Nhi khoa", Description = "Chuyên khoa nhi", Price = "400.000đ", ShortDescription = "Chăm sóc sức khỏe trẻ em" },
                    new Specialty { Name = "Răng hàm mặt", Description = "Nha khoa thẩm mỹ", Price = "600.000đ", ShortDescription = "Dịch vụ nha khoa" },
                    new Specialty { Name = "Tim mạch", Description = "Bệnh lý tim mạch", Price = "700.000đ", ShortDescription = "Khám và tầm soát tim mạch" },
                    new Specialty { Name = "Xét nghiệm", Description = "Xét nghiệm máu, nước tiểu", Price = "300.000đ", ShortDescription = "Trung tâm xét nghiệm" }
                );
